 ...
 */
final class Version20220406132554 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE devis ADD confirm VARCHAR(255) DEFAULT NULL');
    }
