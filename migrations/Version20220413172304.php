 ...
 */
final class Version20220413172304 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE devis ADD services_id INT DEFAULT NULL');
