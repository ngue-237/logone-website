 ...
 */
final class Version20220303175937 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE images (id INT AUTO_INCREMENT NOT NULL, category_service_id INT NOT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_E01FBE6ACB42F998 (category_service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
