 ...
 */
final class Version20220413133640 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE devis ADD closing_status VARCHAR(60) DEFAULT NULL, ADD job_status VARCHAR(255) DEFAULT NULL');
    }
