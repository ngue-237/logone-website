 ...
 */
final class Version20220331154030 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offre_emploi ADD slug VARCHAR(255) DEFAULT NULL');
    }
