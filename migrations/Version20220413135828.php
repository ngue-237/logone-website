 ...
 */
final class Version20220413135828 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE devis ADD closing_status TINYINT(1) DEFAULT NULL, ADD job_done TINYINT(1) DEFAULT NULL');
    }
