 ...
 */
final class Version20220410171226 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE devis DROP services_id');
    }
