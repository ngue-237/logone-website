 ...
 */
final class Version20220410094008 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offre_emploi DROP niveau_scolaire, CHANGE location location VARCHAR(255) DEFAULT NULL');
    }
