 ...
 */
final class Version20220320122508 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contact DROP phone_number, DROP country');
    }
